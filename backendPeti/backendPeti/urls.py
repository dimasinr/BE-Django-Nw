...
urlpatterns = (
    [
        ...
        path('api/reset-password/', UserPasswordReset.as_view(),
             name='reset-password'),
        ...
        path('api/presence/analysis-employee/',
             PresenceAnalysisEmployee.as_view()),
        path('api/presence/analysis/<int:month>/<int:year>/',
             PresenceAnalysisOn.as_view()),
        path('api/presence/list-analysis/<int:year>/',
             ListPresenceAnalysis.as_view()),
        ...
        path('api/send-notification/', send_notification_api,
